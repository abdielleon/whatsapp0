 ...
 * @returns {Boolean}
 */
const hasTestWord = (messageBody) => {

    const testWord = process.env.TEST_MODE_WORD.toLowerCase();
    const bodyLower = messageBody.toLowerCase();

    if (bodyLower.startsWith(testWord)) {
...
module.exports = {hasTestWord, cleanNumber, saveExternalFile, generateImage, checkIsUrl, checkEnvFile, createClient, isValidNumber}